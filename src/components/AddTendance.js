...
const AddTendanceModal = ({ show, closeModal }) => {
                                        ...
                                        <div className="flex flex-col">
                                            ...
                                            <div class=" relative my-2 ">
                                                ...
                                                <select
                                                    ...
                                                    value={refColor}
                                                    onChange={(event) => {
                                                        setRefColor(event.target.value);
                                                    }}
                                                >
                                                    {
                                                        baseList.map((elm) => <option value={elm._id}>{elm.nameColor}</option>)
                                                    }
                                                </select>
                                            </div>
                                            <div class=" relative my-2 ">
...
export default AddTendanceModal;
